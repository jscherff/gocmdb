...
func NewDevice(gd *gousb.Device) (this *Magtek, err error) {

	var errs []string

	gapi := &api.Generic{}
	mapi := &api.Magtek{}
	this := &Device{gd,gapi,mapi}

	if err = this.Generic.Init(); err != nil {
		errs = append(errs, "Generic")
	}
	if err = this.Magtek.Init(); err != nil {
		errs = append(errs, "Magtek")
	}
...
func (this *Magtek) Refresh() (err error) {
	...
	if err = this.Magtek.Refresh(); err != nil {
		errs = append(errs, "Magtek")
	}
